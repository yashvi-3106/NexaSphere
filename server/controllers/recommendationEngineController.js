...
export const getRecommendations = (req, res) => {
  try {
    ...
    const recommendations = recommendationEngineService.getRecommendations(userId, category, limit);
...
export const getTrendingRecommendations = (req, res) => {
  try {
    const data = recommendationEngineService.getTrendingRecommendations();
...
export const submitFeedback = (req, res) => {
  try {
    ...
    if (!recommendationId || !feedback) {
      return res.status(400).json({
        success: false,
        message: 'Recommendation ID and feedback are required',
      });
    }

    const response = recommendationEngineService.submitFeedback(userId, recommendationId, feedback);
...
export const updateInterests = (req, res) => {
  try {
    ...
    const result = recommendationEngineService.updateInterests(userId, interests);
...
export const getRecommendationExplanation = (req, res) => {
  try {
    ...
    const explanation = recommendationEngineService.getRecommendationExplanation(recommendationId);
...
export const markNotInterested = (req, res) => {
  try {
    ...
    const result = recommendationEngineService.markNotInterested(userId, recommendationId);
...
export const refreshRecommendations = (req, res) => {
  try {
    ...
    const data = recommendationEngineService.refreshRecommendations(userId);
...
export const getRecommendationStats = (req, res) => {
  try {
    const stats = recommendationEngineService.getRecommendationStats();
