...
router.post('/admin', validate(createFaqSchema), adminAuthMiddleware.requireAdmin, faqController.adminCreateFAQ);
router.put('/admin/:id', validate(updateFaqSchema), adminAuthMiddleware.requireAdmin, faqController.adminUpdateFAQ);
router.delete('/admin/:id', validate(deleteFaqSchema), adminAuthMiddleware.requireAdmin, faqController.adminDeleteFAQ);
